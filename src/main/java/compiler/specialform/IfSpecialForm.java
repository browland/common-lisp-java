...
public class IfSpecialForm implements SpecialForm {
    ...
    public void walkTree(RList rlist, TreeWalker treeWalker, AsmGenerator asmGenerator, Function currentFunctionScope) {
        ...
        treeWalker.walkTree(conditionNode, currentFunctionScope);
        ...
        treeWalker.walkTree(trueNode, currentFunctionScope);
        ...
        treeWalker.walkTree(falseNode, currentFunctionScope);
        asmGenerator.generateUnconditionalJump(exitLabel);  // jump to exit
