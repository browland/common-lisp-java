    ...
    public void walkTree(RList rlist, TreeWalker treeWalker, BufferedWriter bw, AsmGenerator asmGenerator) throws IOException {
        ...
        if (symbolNode instanceof Atom atom) {
            ...
            if (typedAtom instanceof SymbolAtom symbolAtom) {
                ...
                asmGenerator.generateJumpInstructionForNonZeroReturnValue(bw, exitLabel);
                ...
                bw.write("mov x1, x0  ; move result of evaluating defvar value into second arg before calling _put_symbol\n");
